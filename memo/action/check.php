...
if (isset($_POST['ok'])) {
    ...
    try {
        ...
        // var_dump($userpostResult[0]['title']);
    ...
    try {
        $sql = "INSERT INTO news (news_id,post_id,post_insert_date,joining_id,result,message,count) VALUES ( :news_id,:post_id,:post_insert_date,:joining_id,:result, :message,1)";
        $stm = $dbConnect->prepare($sql);
        if ($stm) {
